...
const AboutsPage = () => {
  const stats = [
    ...
    { value: "10+", label: "Countries", Icon: FiGlobe },
    { value: "1000+", label: "Happy Clients", Icon: FiHeart },
  ...
  return (
    <div className="relative min-h-screen flex flex-col">
          ...
          >
            {stats.map((stat, index) => {
              ...
              return (
                <motion.div
                  key={index}
                  className="bg-gray-900/70 p-8 rounded-xl text-center border border-gray-700 hover:border-bright-orange transition-all"
                  whileHover={{ y: -10 }}
                  initial={{ opacity: 0, y: 50 }}
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-300 mb-6">
              Founded in 2015, we started as a small team of passionate
              technologists with a vision to revolutionize remote collaboration.
              What began as a simple idea has now grown into a global platform
              serving thousands of businesses worldwide.
            </p>
            <p className="text-lg text-gray-300 mb-8">
              Our journey hasn't been easy, but through dedication and
              innovation, we've overcome every challenge to build solutions that
              truly make a difference in how teams work together.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {coreValues.map((value, index) => (
              <motion.div
                key={index}
                className="bg-gray-900/70 p-8 rounded-xl border border-gray-700 hover:border-bright-orange transition-all"
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 text-center">
        <motion.div
          className="max-w-4xl mx-auto bg-gray-900/70 rounded-xl p-12 border border-gray-700"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
        >
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Join thousands of businesses revolutionizing their workflow with our
            platform.
          </p>
